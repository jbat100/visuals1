...
[AddComponentMenu("OSC/Configurable Event Receiver")]
public class ConfigurableEventReceiver : MonoBehaviour
{
    ...
    [SerializeField] EventReceiverConfiguration _configuration;
    ...
    void RegisterCallback()
    {
        ...
        var server = OscMaster.GetSharedServer(_configuration.UDPPort);
        server.MessageDispatcher.AddCallback(_oscAddress, OnDataReceive);

        _currentPort = _configuration.UDPPort;
